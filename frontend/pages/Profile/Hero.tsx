    ...
    <div className="relative max-w-3xl mx-auto p-4 md:p-8 text-foreground font-sans">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-10">
        ...
        <ImageDropdown name={name} isStory={isStory}>
          ...
          >
            <Avatar className="relative w-24 h-24 md:w-32 md:h-32">
              <AvatarImage
                width={"auto"}
                src={avatarUrl}
                alt="Profile Image"
              ...
              <AvatarBadge className="absolute bottom-1 right-1 md:bottom-2 md:right-2 w-6 h-6 md:w-8 md:h-8 rounded-full border-4 border-background bg-green-600 dark:bg-green-800" />
            </Avatar>
          </Button>
        </ImageDropdown>
