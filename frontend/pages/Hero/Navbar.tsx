      ...
      <Menubar className="pointer-events-auto h-12 gap-1 rounded-full border border-border bg-background/95 px-3 shadow-md backdrop-blur supports-[backdrop-filter]:bg-background/60">
        ...
        <MenubarMenu>
          ...
          <MenubarContent align="end" className="w-64 rounded-xl p-2">
            ...
            <MenubarItem className="flex items-center gap-3 py-2 text-blue-500 focus:text-blue-600" disabled>
            ...
            <MenubarItem className="flex cursor-pointer items-center gap-3 py-2 text-destructive focus:bg-destructive/10 focus:text-destructive">
