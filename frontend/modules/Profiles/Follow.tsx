              ...
              {follow.data.map((f) => {
                ...
                return (
                  <CommandItem key={f.id}>
                    {f.follower && (
                      <Item>
                        <ItemMedia onClick={() => router.push(`/profiles/${f.follower.id}`)}>
                          <Avatar>
                        ...
                        <ItemContent onClick={() => router.push(`/profiles/${f.follower.id}`)}>
                    ...
                    {f.following && (
                      <Item>
                        <ItemMedia onClick={() => router.push(`/profiles/${f.following.id}`)}>
                          <Avatar>
                        ...
                        <ItemContent onClick={() => router.push(`/profiles/${f.following.id}`)}>
